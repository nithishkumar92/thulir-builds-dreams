...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-gold text-white hover:shadow-gold hover:-translate-y-0.5",
        destructive:
        ...
        hero: "bg-gradient-gold text-white shadow-gold hover:shadow-large hover:-translate-y-1 font-semibold",
        "outline-gold": "border-2 border-primary bg-transparent text-primary hover:bg-gradient-gold hover:text-white hover:-translate-y-0.5",
      },
      size: {
